import { CircleIcon, ScanIcon, ScanLineIcon, TriangleIcon } from 'lucide-react';
...
const steps = [
  ...
  { icon: CircleIcon, label: 'Finializing your website...' },
];
...
const LoaderSteps = () => {
  ...
  return (
    ...
    >
      <div
        className='absolute insert-0 bg-linear-to-br from-blue-500/10
        via-purple-500/10 to-fuchsia-500/10 blur-3xl animate-pulse'
      ></div>
      <div className='relative z-10 w-32 h-32 flex items-center justify-center'>
        <div
          className='absolute insert-0 rounded-full border border-indigo-400
      ...
      <p
        className='text-xs text-gray-400 mt-2 transition-opacity duration-700
      opacity-100'
      >
