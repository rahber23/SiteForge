  ...
  transition-all ${isMenuOpen ? 'max-sm:w-0 overflow-hidden' : 'w-full'}`}
    >
      <div className='flex flex-col h-full'>
        {/*message container */}
        <div
          className='flex-1 overflow-y-auto no-scrollbar px-3 flex flex-col
            gap-4'
        >
              ...
              if (isMessage) {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`max-w-[80%] p-2 px-4 rounded-2xl
                    ...
                    {isUser && (
                      <div
                        className='w-8 h-8 rounded-full bg-gray-700 flex
                      items-center justify-center'
                      >
                ...
                return (
                  <div
                    key={ver.id}
                    className='w-4/5 mx-auto my-2 p-3
                    ...
                    <div className='flex items-center justify-between'>
                      {project.current_version_index === ver.id ? (
                        ...
                        <button
                          ...
                          className='px-3 py-1 rounded-md text-xs bg-indigo-500 
                      ...
                      >
                        <EyeIcon
                          className='size-6 p-1 bg-gray-700 
