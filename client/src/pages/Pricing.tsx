...
const Pricing = () => {
  ...
  return (
    <>
      <div className='w-full max-w-5x1 mx-auto z-20 max-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          <h2 className='text-gray-100 text-3x1 font-medium'>
            Choose Your Plan
          </h2>
        ...
        <p className='mx-auto text-center text-sm max-w-md mt-10 text-white'>
          ...
          Consume<span className='text-white'>5 creadits</span>. You can
          purchase more creadits to create more projects.
        </p>
      </div>
      <Footer />
    </>
